...
lista = ["BRUNO","ARMARIO","CASA","CARRO","ESCOLA","ELEFANTE","CACHORRO","GATO","PAPAGAIO","BRASIL"]
numero_aleatorio = random.randint(0,len(lista))
# Criando uma variavel palavra
palavra = lista[numero_aleatorio].lower().strip() #Transformando a palavra em letra minuscula e elimando os espaço em branco
